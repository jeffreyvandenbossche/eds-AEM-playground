...
const BsYoutubeVideo = class {
  ...
  componentDidRender() {
    if (!isEmpty.isEmpty(this.videoElementRef) && !isEmpty.isEmpty(this.videoElementRef.parentElement)) {
      this.videoElementRef.parentElement.dir = 'ltr';
    }
  }
