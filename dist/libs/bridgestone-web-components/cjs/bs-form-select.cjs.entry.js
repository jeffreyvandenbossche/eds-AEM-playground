...
const BsFormSelect = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { focused: this.focused }, index.h("bs-form-field", { ref: (el) => {
        ...
        this.selectWrap = el;
      }, id: this.name, class: "custom-select", onFocus: !this.focused ? this.focus : this.focusOut, onClick: !this.focused && this.focus, tabIndex: 0 }, index.h("span", { class: "custom-select-value" }, (_b = this.value) === null || _b === void 0 ? void 0 : _b.text), index.h("select", { ref: (el) => {
        this.selectElRef = el;
        return this.selectElRef;
      }, class: "hidden", required: this.required, id: `hidden-${this.name}`, name: this.name, tabIndex: -1 }, this.parsedOptions.map((option, index$1) => (index.h("option", { selected: option.selected, "aria-selected": option.selected, value: option.value, disabled: option.disabled, "data-index": index$1 }, option.text)))), index.h("div", { "aria-labelledby": this.name }, index.h("ul", { class: "custom-options-wrapper", "aria-haspopup": "listbox", "aria-expanded": "false", role: "group" }, this.parsedOptions.map((option, index$1) => (index.h("li", { ref: (el) => {
        this.customOptions.push(el);
      }, role: "option", class: `custom-option ${option.disabled ? 'is-disabled' : ''}`, tabindex: -1, "aria-disabled": option.disabled ? 'true' : false, "aria-selected": option.selected, "data-index": index$1 }, option.text)))))), index.h("label", { slot: "form-label", class: "form-label", htmlFor: this.name, title: this.label }, this.label, this.required ? index.h("span", { "aria-hidden": "true" }, "\u00A0*") : ''))));
  }
