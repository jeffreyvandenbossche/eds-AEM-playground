...
const BsStoryQuote = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("blockquote", { class: "blockquote", cite: this.source }, index.h("p", { class: "quote-mark" }, index.h("ion-icon", { class: "icon", "aria-hidden": "true", src: index.getAssetPath(`assets/quote.svg`) })), index.h("p", { class: "quote" }, "\"", this.text, "\""), index.h("div", { class: "info" }, index.h("div", { class: "author-image" }, index.h("bs-image", Object.assign({ class: "image" }, this.parsedAuthorImage, { cover: true }))), index.h("dl", { class: "author-info" }, index.h("dt", null, this.authorName), index.h("dd", null, this.authorPosition)))), index.h("script", { type: "application/ld+json" }, JSON.stringify(schema))));
  }
};
__decorate([
  memoize.Memoize('authorImage')
], BsStoryQuote.prototype, "parsedAuthorImage", null);
BsStoryQuote.style = storyQuoteCss;

exports.bs_story_quote = BsStoryQuote;

//# sourceMappingURL=bs-story-quote.cjs.entry.js.map