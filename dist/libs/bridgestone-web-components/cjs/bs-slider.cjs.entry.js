...
const BsSlider = class {
  ...
  render() {
    return (index.h(index.Host, null, this.slides && (index.h("div", { class: this.navigationOverlay ? 'overlay' : 'head' }, index.h("div", { class: `navigation ${this.navigationOverlay ? 'navigation--overlay' : ''}`, ref: (el) => {
...
//# sourceMappingURL=bs-slider.cjs.entry.js.map