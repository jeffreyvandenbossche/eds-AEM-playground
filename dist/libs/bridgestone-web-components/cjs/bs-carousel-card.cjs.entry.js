...
const BsCarouselCard = class {
  ...
  get parsedImageCollection() {
    const parsed = parseIfString.parseIfString(this.imageCollection);
    const length = breakpoints.compareBreakpoint('min', breakpoints.Breakpoint.md) && !this.slim ? 4 : 3;
  ...
  render() {
    ...
    return (index.h(index.Host, { class: this.slim ? 'is-slim' : '' }, index.h("div", { class: "carousel-card" }, this.parsedImageCollection.map((image, index$1) => (index.h("bs-click-action", { name: "open-carousel-modal", value: Object.assign({ index: index$1 }, carouselData), class: "card-item" }, index.h("bs-image", { class: "card-image", src: image.src, srcset: image.srcset, width: image.width, height: image.height, imageSizes: "200px, 400px", altText: image.altText, itemprop: image.itemprop, cover: true })))), index.h("bs-click-action", { name: "open-carousel-modal", class: "card-item", value: Object.assign({ index: 0 }, carouselData), tagClass: "button-square" }, index.h("span", { class: "icon" }, index.h("bs-icon", { name: icon_types.IconName.Gallery })), index.h("bs-text", { text: this.cta, size: text_types.TextSize.Default })))));
  }
};
__decorate([
...
exports.bs_carousel_card = BsCarouselCard;

//# sourceMappingURL=bs-carousel-card.cjs.entry.js.map