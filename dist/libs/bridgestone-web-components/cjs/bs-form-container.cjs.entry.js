...
const BsFormContainer = class {
   ...
   */
  render() {
    return (index.h(index.Host, null, index.h("form", { class: `form-container ${this.isFormSending ? 'is-sending' : ''}`, action: this.action, method: "dialog" }, index.h("slot", null), this.formHasErrors && index.h("p", { class: "form-error" }, this.invalidFormMessage, "\u00A0"), this.submitHasFailed && index.h("p", { class: "form-error" }, this.submitErrorMessage, "\u00A0"))));
  }
