...
const BsNewsletterBanner = class {
  constructor(hostRef) {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "newsletter-banner" }, index.h("div", { class: "text-wrapper" }, index.h("bs-title", { tag: title_types.TitleTag.H2, text: this.sectionTitle, size: title_types.TitleSize.Head2, variant: title_types.TitleVariant.Slash }), index.h("bs-text", { text: this.subtitle, size: text_types.TextSize.Small })), index.h("bs-button", Object.assign({}, this.parsedButton, { isFullWidth: breakpoints.compareBreakpoint('max', breakpoints.Breakpoint.md), variant: button_types.ButtonVariant.Primary })))));
  }
};
__decorate([
  memoize.Memoize('button')
], BsNewsletterBanner.prototype, "parsedButton", null);
BsNewsletterBanner.style = newsletterBannerCss;

exports.bs_newsletter_banner = BsNewsletterBanner;

//# sourceMappingURL=bs-newsletter-banner.cjs.entry.js.map