...
import { Host, h, setMode } from '@stencil/core';
import { ButtonType } from './button.types';
import { Mode } from '../../../utils/modes';
setMode((el) => el.getAttribute('mode') || Mode.Bridgestone);
/**
...
export class BsButton {
  ...
  static get originalStyleUrls() {
    return {
      "bridgestone": ["button.scss"],
      "firststop": ["button.firststop.scss"]
    };
  }
  static get styleUrls() {
    return {
      "bridgestone": ["button.css"],
      "firststop": ["button.firststop.css"]
    };
  }
  static get properties() {
    return {
      "mode": {
        ...
        "complexType": {
          "original": "Mode",
          "resolved": "Mode.Bridgestone | Mode.Firststop",
          "references": {
            "Mode": {
              "location": "import",
              "path": "../../../utils/modes"
        ...
        "docs": {
          "tags": [],
          "text": "Button's theme mode"
        },
        "attribute": "mode",
        "reflect": false,
        "defaultValue": "Mode.Bridgestone"
      },
      "text": {
        "type": "string",
        "mutable": false,
